...
import lk.parinda.safemellow.keylog.latin.common.UnicodeSurrogate;
import lk.parinda.safemellow.keylog.latin.settings.SpacingAndPunctuations;
import lk.parinda.safemellow.keylog.latin.utils.CapsModeUtils;
import lk.parinda.safemellow.keylog.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See lk.parinda.safemellow.keylog.latin.common.Constants.UnicodeSurrogate
